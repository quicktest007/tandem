function Footer() {
  return (
    <footer className="px-6 py-12 md:py-16 border-t border-navy/5 bg-white/30">
      <div className="mx-auto max-w-6xl flex flex-col sm:flex-row items-center justify-between gap-6">
        <a href="#" className="flex items-center gap-2 text-navy font-semibold transition-opacity hover:opacity-80">
